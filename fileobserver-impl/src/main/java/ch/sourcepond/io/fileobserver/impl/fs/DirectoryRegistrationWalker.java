 ...
 * will be informed through their {@link FileObserver#modified(DispatchKey, Path)}. Each detected
...
class DirectoryRegistrationWalker {
     ...
     * Additionally, it passes any detected file to {@link FileObserver#modified(DispatchKey, Path)} to the observers
     * specified.
     *
